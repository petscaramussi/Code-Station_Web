            ...
            <div class="content">
              <ul >
                <li id="navpagina"><a href="pagina"><p>Main</p></a></li>
                    ...
                    <text id="dropdown">        
                <li class="dropdown">
    <a style="color:white;background-color:#72706f" href="javascript:void(0)" class="dropbtn action-item">Java</a>
    <div class="dropdown-content">
      ...
      <a href="java-extras">Extras</a>
              ...
              <?php } ?>
                ...
                <li ><a href="configuracao" style="text-decoration:none"><p>Perfil&nbsp&nbsp<i class="fas fa-user-edit"></i></p></a></li>
